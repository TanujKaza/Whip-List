...
<head>
  ...
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="#"><i class="fa fa-list btn-nav-toggle-responsive text-white"></i> <span class="logo">RS<strong>E</strong>T <i class="fa fa-bookmark"></i></span></a>
  </div>
